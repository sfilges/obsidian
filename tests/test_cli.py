...
class TestImportCommand:
    ...
    @patch("obsidian.cli.import_doc")
    @patch("obsidian.cli.get_current_config")
    def test_import_file(self, mock_config, mock_import_doc, tmp_path):
        ...
        # Check delegation
        mock_import_doc.import_file.assert_called_once()
        args, kwargs = mock_import_doc.import_file.call_args
        assert args[0] == input_file.resolve()
        assert kwargs["extract"] is False

    @patch("obsidian.cli.import_doc")
    @patch("obsidian.cli.get_current_config")
    def test_import_directory(self, mock_config, mock_import_doc, tmp_path):
        ...
        # Check delegation
        mock_import_doc.bulk_import.assert_called_once()
        args, kwargs = mock_import_doc.bulk_import.call_args
        assert args[0] == input_dir.resolve()
        assert kwargs["extract"] is False

    @patch("obsidian.cli.import_doc")
    @patch("obsidian.cli.get_current_config")
    def test_import_url(self, mock_config, mock_import_doc, tmp_path):
    ...
    @patch("obsidian.cli.import_doc")
    @patch("obsidian.cli.get_current_config")
    def test_import_with_extract(self, mock_config, mock_import_doc, tmp_path):
